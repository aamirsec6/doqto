    ...
    <section id="contact" className="bg-peach py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mt-6 text-lg text-text-muted">
          For partnerships, pilots, or investment — we&apos;d love to hear from
          you.
        </p>

        <a
          href="mailto:hello@doqto.in"
          className="mt-10 inline-block font-display text-2xl font-semibold text-red transition-colors hover:text-red-dark md:text-3xl"
        >
          hello@doqto.in
        </a>
        ...
        <div className="mt-10 flex items-center justify-center gap-6">
          <a
            ...
            className="flex items-center gap-2 text-sm font-medium text-text-muted transition-colors hover:text-red"
          >
